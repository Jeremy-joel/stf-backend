...
- Total raised, donation count, totals by M-Pesa / Card / Bank Transfer
- 6-month bar chart and payment-method pie chart
- Manually log a donation (e.g. a reported bank transfer)
- Search/filter by name, status, method, or date range; delete entries; export to CSV/Excel

**Programs** (`programs.html`)
- Add, edit, delete, reorder, and hide/show the program cards on your homepage, with photo upload

**Gallery** (`gallery.html`)
- Upload, caption, hide/show, and delete "Moments of Hope" gallery photos

**Impact** (`impact.html`)
- Manage the 4 impact cards (Children Supported, Families Empowered, etc.) with photos
